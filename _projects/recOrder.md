...
<div class="detail-page">
  <section class="detail-section detail-overview">
    ...
    <p>
      My role was to understand the technology, model microscope components in Blender, and turn the imaging workflow
      into a clear visual explanation for researchers and technical audiences.
    </p>
    <p class="detail-link">
